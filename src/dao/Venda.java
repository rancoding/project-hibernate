...
public class Venda  implements java.io.Serializable {
    ...
    public Venda(long idvenda, Funcionario funcionario, Loja loja, Tipopagamento tipopagamento, Date datavenda, double valortotal, double valorganho, boolean estado) {
    ...
    public Venda(long idvenda, Funcionario funcionario, Loja loja, Tipopagamento tipopagamento, Date datavenda, double valortotal, double valorganho, boolean estado, Set<Produtovenda> produtovendas) {
       this.idvenda = idvenda;
       this.funcionario = funcionario;
       this.loja = loja;
       this.tipopagamento = tipopagamento;
