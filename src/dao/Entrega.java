...
public class Entrega  implements java.io.Serializable {
    ...
    public Entrega(int identrega, Armazem armazem, Funcionario funcionarioByIdfuncionariorecebe, Funcionario funcionarioByIdfuncionarioentrega, Loja loja, Date dataenvio, Date dataentrega, boolean confirmado) {
    ...
    public Entrega(int identrega, Armazem armazem, Funcionario funcionarioByIdfuncionariorecebe, Funcionario funcionarioByIdfuncionarioentrega, Loja loja, Date dataenvio, Date dataentrega, boolean confirmado, Set<Produtoentrega> produtoentregas) {
       this.identrega = identrega;
       this.armazem = armazem;
       this.funcionarioByIdfuncionariorecebe = funcionarioByIdfuncionariorecebe;
       this.funcionarioByIdfuncionarioentrega = funcionarioByIdfuncionarioentrega;
